...
for class_name, count in classes.items():
    ...
    augmented_class_path = Path(test_augmented_data_path, class_name)
    augmented_class_path.mkdir(parents=True, exist_ok=True)
    ...
    for image_path in class_path.iterdir():
        ...
        shutil.copyfile(image_path, Path(augmented_class_path, image_path.name))
